...
package com.t8rin.imagetoolboxlite.core.data.saving
...
import okio.use
import com.t8rin.imagetoolboxlite.core.domain.image.Metadata
import com.t8rin.imagetoolboxlite.core.domain.saving.FileController
import com.t8rin.imagetoolboxlite.core.domain.saving.RandomStringGenerator
...
import com.t8rin.imagetoolboxlite.core.domain.utils.readableByteCount
    ...
    private fun Context.getSavingFolder(
        ...
        return if (treeUri == null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                ...
                val path = "${Environment.DIRECTORY_DOCUMENTS}/EditsPhoto"
