...
package com.t8rin.imagetoolboxlite.core.settings.data
...
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.ADD_ORIGINAL_NAME_TO_FILENAME
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.ADD_SEQ_NUM_TO_FILENAME
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.ADD_SIZE_TO_FILENAME
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.ALLOW_ANALYTICS
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.ALLOW_BETAS
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.ALLOW_CRASHLYTICS
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.ALLOW_IMAGE_MONET
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.AMOLED_MODE
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.APP_COLOR_TUPLE
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.APP_OPEN_COUNT
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.AUTO_CACHE_CLEAR
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.BORDER_WIDTH
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.COLOR_TUPLES
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.CONFETTI_ENABLED
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.CONFETTI_TYPE
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.COPY_TO_CLIPBOARD_MODE
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.DRAG_HANDLE_WIDTH
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.DRAW_APPBAR_SHADOWS
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.DRAW_BUTTON_SHADOWS
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.DRAW_CONTAINER_SHADOWS
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.DRAW_FAB_SHADOWS
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.DRAW_SLIDER_SHADOWS
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.DRAW_SWITCH_SHADOWS
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.DYNAMIC_COLORS
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.EMOJI_COUNT
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.EXIF_WIDGET_INITIAL_STATE
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.FAB_ALIGNMENT
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.FILENAME_PREFIX
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.FILENAME_SUFFIX
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.FONT_SCALE
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.GROUP_OPTIONS_BY_TYPE
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.ICON_SHAPE
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.IMAGE_PICKER_MODE
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.INITIAL_OCR_CODES
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.INVERT_THEME
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.LOCK_DRAW_ORIENTATION
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.MAGNIFIER_ENABLED
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.NIGHT_MODE
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.OVERWRITE_FILE
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.PRESETS
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.RANDOMIZE_FILENAME
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.SAVE_FOLDER_URI
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.SCREENS_WITH_BRIGHTNESS_ENFORCEMENT
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.SCREEN_ORDER
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.SCREEN_SEARCH_ENABLED
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.SECURE_MODE
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.SELECTED_EMOJI_INDEX
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.SELECTED_FONT_INDEX
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.SHOW_UPDATE_DIALOG
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.THEME_CONTRAST_LEVEL
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.THEME_STYLE
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.USE_EMOJI_AS_PRIMARY_COLOR
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.USE_PIXEL_SWITCH
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.USE_RANDOM_EMOJIS
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.VIBRATION_STRENGTH
import com.t8rin.imagetoolboxlite.core.settings.data.SettingKeys.WELCOME_SEEN
...
internal class SettingsRepositoryImpl @Inject constructor(
    ...
    override fun getSettingsStateFlow(): Flow<SettingsState> = dataStore.data.map { prefs ->
        SettingsState(
            ...
            welcomeSeen = prefs[WELCOME_SEEN] ?: default.welcomeSeen
        )
    }
    ...
    override fun createBackupFilename(): String {
        ...
        return "edits_photo_$timeStamp.imtbx_backup"
    }
